...
import com.example.sook.databinding.ActivitySook10Binding

class Sook10Fragment : Fragment() {
    private var binding: ActivitySook10Binding? = null

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = ActivitySook10Binding.inflate(inflater, container, false)
        ...
        binding!!.taphome.setOnClickListener {
            (activity as? PageChangeCallback)?.changePage(0) // sookActivity6로 이동
        }
